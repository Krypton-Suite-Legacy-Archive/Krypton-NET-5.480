...
namespace ComponentFactory.Krypton.Toolkit.ControlsToolkit.Test
{
    /// <summary>
    ...
    [Designer("ComponentFactory.Krypton.Toolkit.KryptonPaletteDesigner, ComponentFactory.Krypton.Design, Version=4.801.0.0, Culture=neutral, PublicKeyToken=a87e673e9ecb6e8e")]
    ...
    public class KryptonPalette : Component, IPalette
    {
        ...
        private const int PALETTE_VERSION = 18;
        ...
        private XmlDocument ExportToXmlDocument(bool ignoreDefaults)
        {
            ...
            try
            {
                ...
                root.SetAttribute("Version", PALETTE_VERSION.ToString());
